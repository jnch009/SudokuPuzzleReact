...
const NavBar = ({ isAuthenticated, navClickHandlers, isSideBar }) => {
  const navSection = <>
    <NavBarItem linkTo='/credits' onClick={navClickHandlers.handleCreditsClick} name='Credits'/>
    <NavBarItem linkTo='/difficulty' onClick={navClickHandlers.handleDifficultyClick} name='Difficulty'/>
    <NavBarItem linkTo='/solve' onClick={navClickHandlers.handleSudokuSolver} name='Solve'/>
